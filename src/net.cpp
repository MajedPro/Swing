...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Swing " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
// The first name is used as information source for addrman. //First is for human readable? Someone broke this comment.
// The second name should resolve to a list of seed addresses.
static const char *strDNSSeed[][2] = {
    {"104.236.29.198", "104.236.29.198"}, //Primary Seed Node
	{"swing.suprnova.cc", "swing.suprnova.cc"}, //Supernova Pool Node(assuming they list Swing)
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Swing is probably already running."), addrBind.ToString().c_str());
        else
